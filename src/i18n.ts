...
const messages: Record<string, { zh: string; en: string }> = {
  ...
  openMotion: { zh: '打开动作文件', en: 'Open Motion File' },
  exportMotionJson: { zh: '导出为 JSON 动作', en: 'Export as JSON' },
  loadSample: { zh: '加载示例动作', en: 'Load Sample Motion' },
  dropHint: { zh: '拖拽 .bvh / .json 文件到此处，或点击上方按钮选择文件', en: 'Drag & drop a .bvh or .json file here, or use the button above' },
  dropNow: { zh: '松开以加载动作文件', en: 'Release to load the motion file' },
